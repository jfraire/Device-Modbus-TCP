=head1 NAME Device-Modbus-TCP version 0.02

This distribution aims towards implementing the Modbus protocol over TCP/IP in Perl. It should make it possible to write Modbus TCP clients and servers.
...
As of today, simple clients and servers both with Modbus RTU and Modbus TCP have been tested. Only the Modbus RTU clients have been tested with industrial equipment.
